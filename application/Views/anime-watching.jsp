            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="breadcrumb__links">
                        ...
                        <a href="${pageContext.request.contextPath}  /categories/ ${categorie.type_id }">${categorie.type_name }</a>
                        <span>${films.flim_name} : ${films.film_tacgia} </span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="anime__video__player">
                        <video id="player" playsinline controls data-poster="<c:url value="/resources/videos/anime-watch.jpg" />">
						    <source src="${watch.episode_video }" type="video/mp4" />
                    ...
                    <div class="anime__details__episodes">
                        ...
                        <c:forEach var="item" items="${episodes }">
                         	<a href="${pageContext.request.contextPath}/${categorie.type_id }/watch/${item.film_id}/${item.episode_id}#player">Ep ${item.episode_name  }</a>
                        </c:forEach>
                    ...
                    <div class="anime__details__review">
                        ...
                        <div class="anime__details__form">
                            ...
                            <form:form modelAttribute="commentModel" id="formcomment">
                            	<form:hidden path="commet_film" value="${films.film_id}"/>
