        ...
        <ul class="menu">
            ...
            <li
                ...
                <ul class="submenu ">
                    ...
                    <li class="submenu-item ">
                        <a href="${pageContext.request.contextPath}/admin/anime">Anime</a>
                    </li>
                </ul>
            </li>                  
                        ...
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <h6 class="font-extrabold mb-0"><fmt:formatNumber pattern="#,##0" value="${sum_view }"/></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <h6 class="font-extrabold mb-0"><fmt:formatNumber pattern="#,##0" value="${sum_user}"/></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        <div class="card-body px-3 py-4-5">
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <h6 class="text-muted font-semibold">Saved Video</h6>
                                    <h6 class="font-extrabold mb-0"><fmt:formatNumber pattern="#,##0" value="${sum_video }"/></h6>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <h5 class="mb-0 ms-3">Southern </h5>
                                    </div>
                                </div>
                                <div class="col-6">
                ...
                <div class="card-body py-4 px-5">
                    <div class="d-flex align-items-center">
                        <div class="avatar avatar-xl">
                            <img src="https://scontent.fdad3-1.fna.fbcdn.net/v/t1.6435-9/157307061_2517975938506502_2205240183652711162_n.jpg?_nc_cat=110&ccb=1-5&_nc_sid=09cbfe&_nc_ohc=atsBBFXGINIAX8K8s6b&_nc_ht=scontent.fdad3-1.fna&oh=00_AT-sKBU5ca3zXF4-jSd8GI3Qqo1YPH3Zk5V3p5Lj-Hz5Rw&oe=61FBDDA0" alt="Face 1">
                        </div>
                        <div class="ms-3 name">
                            <h5 class="font-bold">Trung Hau</h5>
                            <h6 class="text-muted mb-0">@acelatwo</h6>
                        </div>
                    </div>
                </div>
            </div>
