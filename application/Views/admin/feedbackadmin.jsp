...
<head>
	...
	<link rel="stylesheet" href="<c:url value="/resources/admin/css/pages/email.css"/>">
                            ...
                            <div class="list-group list-group-messages">
                                <a href="#" class="list-group-item pt-0 active" id="inbox-menu">
                                    <div class="fonticon-wrap d-inline me-3">
                                        ...
                                        <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                            <use
                                                xlink:href="<c:url value="/resources/admin/vendors/bootstrap-icons/bootstrap-icons.svg#envelope"/>" />
                                        </svg>
                                        </i>
                                    </div>
                                    Inbox
                                ...
                                <a href="#" class="list-group-item">
                                    <div class="fonticon-wrap d-inline me-3">
                                        ...
                                        <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                            <use
                                                xlink:href="<c:url value="/resources/admin/vendors/bootstrap-icons/bootstrap-icons.svg#archive"/>" />
                                        </svg>
                                    </div>
                                    Sent
                                </a>
                                <a href="#" class="list-group-item">
                                    <div class="fonticon-wrap d-inline me-3">
                                        ...
                                        <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                            <use
                                                xlink:href="<c:url value="/resources/admin/vendors/bootstrap-icons/bootstrap-icons.svg#pencil"/>" />
                                        </svg>
                                    </div> Draft
                                </a>
                                <a href="#" class="list-group-item">
                                    <div class="fonticon-wrap d-inline me-3">
                                        ...
                                        <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                            <use xlink:href="<c:url value="/resources/admin/vendors/bootstrap-icons/bootstrap-icons.svg#star"/>" />
                                        </svg>
                                    </div>
                                    Starred
                                </a>
                                <a href="#" class="list-group-item">
                                    <div class="fonticon-wrap d-inline me-3">
                                        ...
                                        <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                            <use
                                                xlink:href="<c:url value="/resources/admin/vendors/bootstrap-icons/bootstrap-icons.svg#info-circle"/>" />
                                        </svg>
                                    </div>
                                    Spam
                                    <span
                                ...
                                <a href="#" class="list-group-item">
                                    <div class="fonticon-wrap d-inline me-3">
                                        <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                            <use
                                                xlink:href="<c:url value="/resources/admin/vendors/bootstrap-icons/bootstrap-icons.svg#trash"/>" />
                                        </svg>
                                    </div>
                                    Trash
                                </a>
                                ...
                                <div class="email-action">
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        <span class="fonticon-wrap">
                                                            ...
                                                            <svg class="bi" width="1.5em" height="1.5em"
                                                                fill="currentColor">
                                                                <use
                                                                    xlink:href="<c:url value="/resources/admin/vendors/bootstrap-icons/bootstrap-icons.svg#folder"/>" />
                                                            </svg>
                                                        </span>
                                                    </button>
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        <span class="fonticon-wrap">
                                                            ...
                                                            <svg class="bi" width="1.5em" height="1.5em"
                                                                fill="currentColor">
                                                                <use
                                                                    xlink:href="<c:url value="/resources/admin/vendors/bootstrap-icons/bootstrap-icons.svg#tag"/>"/>
                                                            </svg>
                                                        </span>
                                                    </button>
                                                    <div class="dropdown-menu dropdown-menu-right"
                                    ...
                                    <div
                                        ...
                                        <div class="email-fixed-search flex-grow-1">
                                            ...
                                            <div class="form-group position-relative  mb-0 has-icon-left">
                                                ...
                                                <div class="form-control-icon">
                                                    <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                                        <use
                                                            xlink:href="<c:url value="/resources/admin/vendors/bootstrap-icons/bootstrap-icons.svg#search"/>" />
                                                    </svg>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <button class="btn btn-icon email-pagination-prev d-none d-sm-block">
                                            <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                                <use
                                                    xlink:href="<c:url value="/resources/admin/vendors/bootstrap-icons/bootstrap-icons.svg#chevron-left"/>" />
                                            </svg>
                                        </button>
                                        <button class="btn btn-icon email-pagination-next d-none d-sm-block">
                                            <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                                <use
                                                    xlink:href="<c:url value="/resources/admin/vendors/bootstrap-icons/bootstrap-icons.svg#chevron-right"/>" />
                                            </svg>
                                        </button>
                                    </div>
                                </div>
                                        ...
                                        <li class="media mail-read">
                                            <div class="user-action">
                                                ...
                                                <span class="favorite text-warning">
                                                    <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                                        <use
                                                            xlink:href="<c:url value="/resources/admin/vendors/bootstrap-icons/bootstrap-icons.svg#star-fill"/>" />
                                                    </svg>
                                                </span>
                                            </div>
                                            <div class="pr-50">
                                        ...
                                        <li class="media mail-read">
                                            <div class="user-action">
                                                ...
                                                <span class="favorite">
                                                    <svg class="bi" width="1.5em" height="1.5em" fill="currentColor">
                                                        <use
                                                            xlink:href="<c:url value="/resources/admin/vendors/bootstrap-icons/bootstrap-icons.svg#star"/>" />
                                                    </svg>
                                                </span>
                                            </div>
                                            <div class="pr-50">
