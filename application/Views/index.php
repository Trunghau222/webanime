...
<body>
    ...
    <section class="hero">
        <div class="container">
            ...
            <c:forEach var="item" items="${top_film_views }">
	            <div class="hero__items set-bg"   data-setbg="${item.film_img }">
	                    <div  class="row">
	                        <div class="col-lg-6">
	                            <div class="hero__text">
	                                <div class="label">${item.type_name }</div>
	                                <h2>${item.film_name_real }</h2>
	                                <p>After 30 days of travel across the world...</p>
	                                <a href="${pageContext.request.contextPath}/${item.type_id}/watch/${item.film_id}/1#player"><span>Watch Now</span> <i class="fa fa-angle-right"></i></a>
	                            </div>
	                        </div>
	                    </div>
	                </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="trending__product">
                        ...
                        <div class="row">
	                       <c:forEach var="item" items="${trending_now}">
	                        		<div class="col-lg-4 col-md-6 col-sm-6" " >
		                                <div class="product__item">
		                                    <div class="product__item__pic set-bg" data-setbg="${item.film_img }">
		                                        <div class="ep">${item.film_current_episode } / ${item.film_end_episode}</div>
		                                        <div class="comment"><i class="fa fa-comments"></i> 11</div>
		                                        <div class="view"><i class="fa fa-eye">${item.flim_views }</i></div>
		                                    </div>
		                                    <div class="product__item__text">
		                                        ...
		                                        <h5><a href="${pageContext.request.contextPath}/thong-tin-phim/${item.film_id}">${item.film_name_real}</a></h5>
		                                    </div>
		                                </div>
	                            	</div>
	                        </c:forEach>
                       ...
                       <div class="live__product">
                        ...
                        <div class="row">
		                    <c:forEach var="item" items="${active_now}">
			                        		<div class="col-lg-4 col-md-6 col-sm-6">
				                                <div class="product__item">
				                                    <div class="product__item__pic set-bg" data-setbg="${item.film_img }">
				                                        <div class="ep">${item.film_current_episode } / ${item.film_end_episode}</div>
